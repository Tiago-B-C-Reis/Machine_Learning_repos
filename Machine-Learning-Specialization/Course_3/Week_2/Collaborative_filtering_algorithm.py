...
from Package_1 import recsys_utils
...
print(f"Average rating for movie 1 : {tsmean:0.1f} of 5")
...
movieList, movieList_df = recsys_utils.load_Movie_List_pd()
...
my_ratings[988] = 2   # Eternal Sunshine of the Spotless Mind (2004)
