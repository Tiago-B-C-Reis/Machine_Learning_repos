...
# If we multiply (1 - mask) by -1e9 and add it to the sample input sequences,
# the zeros are essentially set to negative infinity. Notice the difference when taking
# the softmax of the original sequence and the masked sequence:
