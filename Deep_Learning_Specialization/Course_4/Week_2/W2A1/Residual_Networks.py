...
# Run the following code to build the model's graph. If your implementation is incorrect,
# you'll know it by checking your accuracy when running `model.fit(...)` below.
...
# As shown in the Keras Tutorial Notebook, prior to training a model,
# you need to configure the learning process by compiling the model.
...
# Run the following cell to train your model on 10 epochs with a batch size of 32.
# On a GPU, it should take less than 2 minutes.
...
img_path = 'images/my_own_image.jpg'
